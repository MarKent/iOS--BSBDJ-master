...
- (void)viewDidLoad {
    ...
    //设置左侧按钮
    self.navigationItem.leftBarButtonItem = [UIBarButtonItem mk_itemWithNormalImage:@"MainTagSubIcon" highImage:@"MainTagSubIconClick" target:self action:@selector(tagClick)];
}
